          ...
          <MM className="metismenu" id="menu">
            <li className={`${thePosh.includes(path) ? "mm-active" : ""}`}>
              ...
              <ul>
                ...
                <li>
                  <Link
                    className={`${path === "products" ? "mm-active" : ""}`}
                    to="/products"
                  >
                    Products
                  </Link>
            ...
            <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
              ...
              <ul>
                ...
                <li>
                  <Link
                    className={`${path === "workout-plan" ? "mm-active" : ""}`}
                    to="/workout-plan"
                  >
                    Workout Plan
                  </Link>
                ...
                <li>
                  <Link
                    className={`${path === "distance-map" ? "mm-active" : ""}`}
                    to="/distance-map"
                  >
                    Distance Map
                  </Link>
                ...
                <li>
                  <Link
                    className={`${
                      path === "personal-record" ? "mm-active" : ""
                    }`}
                    to="/personal-record"
                  >
                    Personal Record
